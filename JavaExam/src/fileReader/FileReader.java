...
public class FileReader {
	...
	public static void readText(AirportController airportController) throws IOException{
		...
		stream.forEach(u -> { 
	        ...
	        airportController.createAirport(airport, country, continent, airfield_length);	
		});
		stream.close();
}
}
